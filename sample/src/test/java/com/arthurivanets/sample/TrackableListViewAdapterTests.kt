...
class TrackableListViewAdapterTests {
    ...
    fun testFooterAdding() {
        ...
        // preparing the dummy data
        val item1 = ArticleItem(Article(1, "Item 1", ""))
        val footerItem1 = FooterItem(FooterInfo(3, "Footer Item 1", ""))
        val footerItem2 = FooterItem(FooterInfo(4, "Footer Item 2", ""))
    ...
    fun testFooterRemoval() {
        ...
        // preparing the dummy data
        val item1 = ArticleItem(Article(1, "Item 1", ""))
        val footerItem = FooterItem(FooterInfo(3, "Footer Item 1", ""))
