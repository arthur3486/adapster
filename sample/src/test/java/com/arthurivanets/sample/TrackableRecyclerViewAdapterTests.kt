...
class TrackableRecyclerViewAdapterTests {


    lateinit var activity : RecyclerViewBasedDemoActivity
    ...
    @Before
    fun setUp() {
        activity = Robolectric.buildActivity(RecyclerViewBasedDemoActivity::class.java)
            .create()
            .start()
            .resume()
            .get()
        ...
        adapter = (recyclerView.adapter as SimpleRecyclerViewAdapter)
        adapter.clear()
    }
